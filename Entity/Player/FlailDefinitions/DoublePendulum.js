...
class BasicFlail extends BaseDefinition_1.default {
    constructor(owner) {
        ...
        this.ropes[0] = new Rope_1.default(this.owner.game, this.owner, this.flails[0], 3, 0.6, 20);
        this.flails[1] = new Flail_1.default(this.owner.game, this.owner);
        this.ropes[1] = new Rope_1.default(this.owner.game, this.flails[0], this.flails[1], 3, 0.6, 20);
    }
}
